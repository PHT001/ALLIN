        ...
        <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <a
                ...
                className="group inline-flex items-center justify-center rounded-full bg-[#E63946] px-8 py-4 text-base font-semibold text-white transition-all hover:bg-[#C1121F] hover:shadow-xl hover:shadow-red-200"
              >
