...
const RECENT = [
  { text: "Le\u00e7on 1 termin\u00e9e", sub: "Comprendre l\u2019IA", time: "Il y a 2h", color: "bg-emerald-500", icon: "check" },
  { text: "Quiz r\u00e9ussi", sub: "Score : 85%", time: "Il y a 3h", color: "bg-[#FF1744]", icon: "quiz" },
  { text: "S\u00e9rie de 3 jours", sub: "Continue comme \u00e7a !", time: "Hier", color: "bg-amber-500", icon: "flame" },
  { text: "Module 1 commenc\u00e9", sub: "D\u00e9couvrir Claude", time: "Hier", color: "bg-blue-500", icon: "layers" },
];
          ...
          <Card initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-6">
            ...
            <div className="p-4 rounded-xl bg-[#F8F9FA] border border-gray-100 mb-5">
              <div className="flex items-center justify-between mb-2.5">
                ...
                <span className="text-[10px] text-gray-400 font-semibold">{accessibleModules.length}/13</span>
              </div>
            ...
            <div className="space-y-0">
              {RECENT.map((item, i) => (
                <div key={i} className={cn("flex items-center gap-3 py-3", i < RECENT.length - 1 && "border-b border-gray-100")}>
                  <div className={cn("w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-white", item.color)}>
