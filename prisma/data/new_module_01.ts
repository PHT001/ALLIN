...
export const MODULE_1_LESSONS = [
  ...
  // ─── LEÇON 6 ───
  {
    order: 6,
    module: 1,
    title: "La roadmap pour lancer ton agence IA",
    slug: "roadmap-lancer-agence-ia",
    duration: "20 min",
    description: "Voir le chemin complet de la formation et comprendre comment chaque module te rapproche de ton objectif.",
    content: blocks([
      { id: "6-1", type: "heading", level: 2, text: "Le chemin complet" },
      { id: "6-2", type: "text", html: "<p>Maintenant que tu sais ce qu'est l'IA, que tu as vu les outils, que tu maîtrises les bases du prompting, et que tu as vu un chatbot se construire en live — voici la suite du programme.</p><p>Chaque module est conçu pour que tu <strong>avances concrètement</strong>. Pas de remplissage.</p>" },

      { id: "6-3", type: "heading", level: 2, text: "Les 13 modules en détail" },
      { id: "6-4", type: "diagram", variant: "timeline", nodes: [
        { id: "m1", label: "Module 1 ✅", description: "Découvrir l'IA & les opportunités — Tu es ici" },
        { id: "m2", label: "Module 2", description: "Prompt engineering avancé & Claude Pro" },
        { id: "m3", label: "Module 3", description: "Créer ton premier site web avec l'IA" },
        { id: "m4", label: "Module 4", description: "Bases de données & Backend (Supabase)" },
        { id: "m5", label: "Module 5", description: "APIs & Intégrations (Stripe, webhooks)" },
        { id: "m6", label: "Module 6", description: "Automatisations (Make, n8n, Zapier)" },
        { id: "m7", label: "Module 7", description: "Chatbots IA — le service le plus rentable" },
        { id: "m8", label: "Module 8", description: "Agents IA autonomes" },
        { id: "m9", label: "Module 9", description: "Construire un MVP complet" },
        { id: "m10", label: "Module 10", description: "Ton offre & tes prix" },
        { id: "m11", label: "Module 11", description: "Trouver des clients" },
        { id: "m12", label: "Module 12", description: "Livrer & fidéliser" },
        { id: "m13", label: "Module 13", description: "Scaler à 10K€/mois" },
      ]},

      { id: "6-5", type: "separator", style: "line" },
      { id: "6-6", type: "heading", level: 2, text: "La logique du parcours" },
      { id: "6-7", type: "diagram", variant: "flow", nodes: [
        { id: "n1", label: "Semaine 1-2", description: "Tu apprends les outils" },
        { id: "n2", label: "Semaine 2-3", description: "Tu construis des solutions" },
        { id: "n3", label: "Semaine 3-4", description: "Tu vends tes services" },
        { id: "n4", label: "Semaine 4-5", description: "Tu scales ton business" },
      ]},

      { id: "6-8", type: "callout", variant: "success", html: "À la fin de la formation, tu auras : les compétences techniques, un portfolio de projets, une offre claire, une méthode de prospection, et un plan structuré pour viser les 10K€/mois de chiffre d'affaires." },

      { id: "6-9", type: "separator", style: "dots" },
      { id: "6-10", type: "heading", level: 2, text: "Prêt à passer à la suite ?" },
      { id: "6-11", type: "text", html: "<p>Le Module 1 t'a donné les bases. Tu sais ce qu'est l'IA, tu connais les outils, tu sais écrire un prompt efficace, tu as vu ce qu'on peut construire, et tu connais le potentiel business.</p><p>Le <strong>Module 2</strong> va t'apprendre à maîtriser Claude comme un pro. Prompt engineering avancé, projets, workflows — le niveau au-dessus.</p>" },
      { id: "6-12", type: "callout", variant: "warning", html: "Les modules 2 à 13 sont disponibles dans la formule <strong>Academy</strong>. Si tu es en formule Starter, c'est le moment de passer à la suite pour débloquer tout le contenu." },

      { id: "6-13", type: "quiz-inline", question: "Quel est le premier service qu'on recommande de vendre ?", options: [
        { id: "a", text: "Des sites web complexes" },
        { id: "b", text: "Des chatbots IA" },
        { id: "c", text: "Des agents IA autonomes" },
      ], correctId: "b", explanation: "Les chatbots sont le service le plus simple à vendre et à livrer. C'est le point d'entrée idéal pour une agence IA." },

      { id: "6-14", type: "checklist", title: "Bilan du Module 1", items: [
        { id: "c1", text: "Je comprends pourquoi l'IA est une opportunité massive" },
        { id: "c2", text: "Je connais les principaux modèles IA et leurs forces" },
        { id: "c3", text: "Je sais écrire un prompt structuré (RCTF)" },
        { id: "c4", text: "Je connais les 5 services d'une agence IA et leurs prix" },
        { id: "c5", text: "J'ai vu comment un chatbot se construit" },
        { id: "c6", text: "Je connais la roadmap complète de la formation" },
      ]},
    ]),
    ...
    quiz: [
      ...
      { type: "mcq", question: "Un prospect te demande : 'Je veux lancer mon agence IA mais je ne sais pas coder et je n'ai aucun client. Par quoi je commence ?' Que lui recommandes-tu ?", options: JSON.stringify(["Apprendre à coder pendant 6 mois avant de chercher des clients", "Commencer par maîtriser les chatbots IA, puis démarcher des entreprises locales avec ce premier service", "Créer un site web d'agence élaboré avant de proposer quoi que ce soit", "Attendre d'avoir un diplôme en IA pour être crédible"]), correctAnswer: "Commencer par maîtriser les chatbots IA, puis démarcher des entreprises locales avec ce premier service", explanation: "La roadmap recommande de commencer par un seul service (les chatbots), de le maîtriser rapidement, puis de démarcher des clients. En 2-3 semaines on peut passer de l'apprentissage à la vente, sans avoir besoin de tout maîtriser." },
    ],
  },
];
