...
export const MODULE_1_LESSONS = [
  ...
  // ─── LEÇON 4 ───
  {
    ...
    content: blocks([
      ...
      { id: "4-10", type: "callout", variant: "success", html: "<strong>Total : 11 000€/mois</strong>. C'est atteignable en 3-6 mois avec les bonnes méthodes. Et ce n'est qu'un exemple." },
  ...
  // ─── LEÇON 6 ───
  {
    ...
    content: blocks([
      ...
      { id: "6-8", type: "callout", variant: "success", html: "À la fin de la formation, tu auras : les compétences techniques, un portfolio de projets, une offre claire, une méthode de prospection, et un plan pour atteindre 10K€/mois." },
