...
export const MODULE_10_LESSONS = [
  // ─── LEÇON 1 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Un workflow n8n de 15 étapes représente quelle valeur perçue pour le client ?", options: JSON.stringify(["15 étapes de code automatisé", "Une prouesse technique complexe", "30 heures de travail manuel économisées chaque mois", "Un logiciel coûteux à maintenir"]), correctAnswer: "30 heures de travail manuel économisées chaque mois", explanation: "Le client ne voit pas '15 étapes de workflow'. Il voit '30 heures de travail manuel économisées par mois'. C'est la valeur perçue qui compte pour fixer le prix, pas la complexité technique." },
    ],
  },
  ...
  // ─── LEÇON 2 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quels sont les 5 types de services IA les plus rentables à vendre ?", options: JSON.stringify(["Chatbots, Automatisations, Sites web IA, Agents IA, Consulting/Formation", "SEO, Design, Réseaux sociaux, Email marketing, Publicité", "Développement mobile, Cloud, DevOps, Data science, Cybersécurité", "WordPress, Shopify, Wix, Webflow, Squarespace"]), correctAnswer: "Chatbots, Automatisations, Sites web IA, Agents IA, Consulting/Formation", explanation: "Les 5 services IA les plus demandés et rentables sont : chatbots & assistants IA, automatisations & workflows, sites web avec IA intégrée, agents IA autonomes, et consulting & formation IA." },
    ],
  },
...
Il reste 1 place disponible ce mois-ci.` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelle est l'erreur classique n°1 quand on construit son offre ?", options: JSON.stringify(["Mettre un prix trop élevé", "Vendre du temps au lieu d'un résultat", "Ne pas avoir de site web", "Offrir trop de garanties"]), correctAnswer: "Vendre du temps au lieu d'un résultat", explanation: "Vendre 'X heures de développement' est l'erreur la plus courante. Le client n'achète pas des heures, il achète 'un chatbot opérationnel livré en 5 jours'. L'offre doit toujours être centrée sur le résultat." },
    ],
  },
...
c'est de l'argent que vous gagnez chaque mois."` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quel type de client a la sensibilité prix la plus faible selon la grille de pricing ?", options: JSON.stringify(["Artisan / TPE (1-5 salariés)", "PME (10-50 salariés)", "ETI / Grand compte (50+ salariés)", "Startup"]), correctAnswer: "ETI / Grand compte (50+ salariés)", explanation: "Les ETI et grands comptes ont une sensibilité prix faible. Leurs budgets sont plus importants et ils cherchent le ROI stratégique, la conformité et la scalabilité. Les projets peuvent aller de 5 000€ à 50 000€." },
    ],
  },
...
[Ton nom] — [mail] — [téléphone]` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelle est la structure correcte du hero de la page d'offre ?", options: JSON.stringify(["Logo + Nom de l'agence + Liste de compétences techniques", "Résultat concret pour le client + Délai + CTA visible", "Vidéo de présentation + Portfolio complet", "Formulaire de contact + Prix détaillé"]), correctAnswer: "Résultat concret pour le client + Délai + CTA visible", explanation: "Le hero doit répondre en 10 secondes : qui tu aides, quel problème tu résous, et comment agir. Le format gagnant est : titre avec résultat concret, sous-titre avec le délai et sans obstacle, CTA 'Réserver un appel'." },
    ],
  },
  ...
  // ─── LEÇON 6 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelle est la meilleure plateforme B2B pour construire son personal branding en tant qu'agence IA ?", options: JSON.stringify(["Instagram", "TikTok", "LinkedIn", "Facebook"]), correctAnswer: "LinkedIn", explanation: "LinkedIn est la meilleure plateforme B2B : tous tes clients potentiels y sont (directeurs, gérants de PME, DRH). 2 posts par semaine sur les problèmes de ta niche suffisent pour générer des prospects inbound en 3 mois." },
    ],
  },
];
