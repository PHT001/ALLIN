...
export const MODULE_11_LESSONS = [
  // ─── LEÇON 1 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "À quel moment faut-il ajouter le réseau local comme canal de prospection ?", options: JSON.stringify(["Dès le jour 1, en parallèle de tout le reste", "Entre les jours 61 et 90, après LinkedIn et le cold email", "Jamais, le digital suffit", "Uniquement quand on a un site web professionnel"]), correctAnswer: "Entre les jours 61 et 90, après LinkedIn et le cold email", explanation: "La roadmap recommande : jours 1-30 LinkedIn only, jours 31-60 LinkedIn + cold email, jours 61-90 on ajoute le réseau local (1 événement/semaine). Objectif final : 10 rendez-vous, 2-3 clients signés." },
    ],
  },
...
— [Ton prénom]` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quel est l'objectif quotidien recommandé pour la prospection LinkedIn ?", options: JSON.stringify(["1 demande de connexion par semaine", "10 demandes de connexion + 5 DMs envoyés par jour", "100 DMs automatisés par jour", "50 posts par jour"]), correctAnswer: "10 demandes de connexion + 5 DMs envoyés par jour", explanation: "L'objectif quotidien est 10 demandes de connexion ciblées et 5 DMs personnalisés. C'est un rythme soutenable qui génère 2-3 rendez-vous par mois avec de la régularité." },
    ],
  },
...
[Prénom] [Nom]` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelles sont les 5 règles pour éviter que ses cold emails atterrissent en spam ?", options: JSON.stringify(["Utiliser des images, des couleurs vives et beaucoup de liens", "Warm-up du domaine, max 50 emails/jour au début, personnalisation, texte pur, SPF/DKIM/DMARC configurés", "Envoyer uniquement le lundi matin et utiliser un objet en majuscules", "Acheter une liste d'emails vérifiée et envoyer depuis Gmail"]), correctAnswer: "Warm-up du domaine, max 50 emails/jour au début, personnalisation, texte pur, SPF/DKIM/DMARC configurés", explanation: "Les 5 règles anti-spam sont : warm-up du domaine 2 semaines avant, jamais plus de 50 emails/jour au début, personnaliser au minimum prénom et entreprise, envoyer du texte pur sans images ni liens multiples, et configurer SPF, DKIM et DMARC sur le domaine." },
    ],
  },
...
→ "Je comprends l'inquiétude. Mais voilà comment ça se passe en pratique :
   ...
   Mes clients disent souvent que la mise en place était plus simple qu'ils le craignaient."` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelles sont les 5 phases d'un appel découverte bien structuré, dans l'ordre ?", options: JSON.stringify(["Présentation, prix, objections, négociation, signature", "Intro, découverte, qualification, présentation, closing", "Pitch, démo, essai gratuit, relance, contrat", "Accueil, présentation de l'agence, portfolio, tarifs, prochaine étape"]), correctAnswer: "Intro, découverte, qualification, présentation, closing", explanation: "Le script suit 5 phases : Intro (2 min) pour cadrer l'appel, Découverte (10 min) pour comprendre la situation, Qualification (3 min) pour vérifier budget/décision/urgence, Présentation (5 min) pour montrer la solution adaptée, et Closing (5 min) pour définir la prochaine étape." },
    ],
  },
...
[Prénom]` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Que faut-il faire pour entretenir son réseau même sans projet actif ?", options: JSON.stringify(["Envoyer un devis chaque mois à tous ses contacts", "Envoyer un article utile une fois par mois sans faire de vente", "Ne rien faire et attendre que les clients reviennent", "Publier des offres promotionnelles sur les réseaux sociaux"]), correctAnswer: "Envoyer un article utile une fois par mois sans faire de vente", explanation: "Envoyer un article utile une fois par mois à ses anciens clients et contacts, sans chercher à vendre, permet de rester top of mind. Quand ils auront besoin de toi ou connaîtront quelqu'un qui en a besoin, tu seras la première personne à laquelle ils penseront." },
    ],
  },
...
3. Mettre à jour les notes d'appels` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelle est la fréquence de relance recommandée pour un prospect 'Tiède' (pas de réponse) ?", options: JSON.stringify(["Relancer chaque jour jusqu'à obtenir une réponse", "Relancer à J+4 et J+9, puis classer en Froid après 3 tentatives", "Attendre 1 mois avant de relancer une seule fois", "Ne jamais relancer pour ne pas déranger"]), correctAnswer: "Relancer à J+4 et J+9, puis classer en Froid après 3 tentatives", explanation: "Pour un prospect Tiède, on relance à J+4 et J+9. Après 3 tentatives sans réponse, on classe en Froid et on planifie une relance dans 2 mois. Pour un prospect Chaud (réponse positive), on relance dans 48h." },
    ],
  },
];
