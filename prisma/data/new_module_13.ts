...
export const MODULE_13_LESSONS = [
  {
    ...
    duration: "20 min",
    description: "Les 4 paliers concrets pour passer de zéro à 10K€/mois avec ton agence IA, les erreurs qui font échouer 80% des gens, et une timeline réaliste de 3 à 6 mois.",
    content: blocks([
      {
        id: "1-1",
        type: "heading",
    ...
    quiz: [
      ...
      { type: "mcq", question: "Au palier 5K-10K€/mois, quelles sont les deux stratégies pour doubler ses revenus ?", options: JSON.stringify(["Baisser ses prix et augmenter le volume", "Augmenter ses prix et déléguer la production", "Créer un SaaS et arrêter le service", "Se former davantage et obtenir des certifications"]), correctAnswer: "Augmenter ses prix et déléguer la production", explanation: "Pour passer de 5K à 10K€/mois, les deux leviers sont : augmenter ses prix (moins de clients, plus de valeur) et déléguer la production à des freelances (plus de clients, même qualité)." },
    ],
  },
  {
    order: 2,
...
POINT DE CONTACT : [Ton nom + méthode préférée (Slack / email)]`,
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quels sont les 3 documents essentiels pour une délégation réussie à un freelance ?", options: JSON.stringify(["CV, lettre de motivation, contrat", "Brief projet, SOP de livraison, checklist de validation", "Facture, devis, bon de commande", "Planning, budget, rapport final"]), correctAnswer: "Brief projet, SOP de livraison, checklist de validation", explanation: "Une délégation réussie repose sur 3 documents : le brief projet (contexte, objectif, contraintes), la SOP de livraison (étapes exactes dans l'ordre), et la checklist de validation (critères à cocher avant envoi au client)." },
    ],
  },
  {
    order: 3,
...
DURÉE TOTALE ESTIMÉE : 3-4h de travail sur J0 à J7`,
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien de temps gagne-t-on par client grâce à un onboarding automatisé sur Make ?", options: JSON.stringify(["5 minutes par client", "30 minutes par client", "Environ 2 heures par client (de 2-3h à 15 min)", "Aucun gain de temps significatif"]), correctAnswer: "Environ 2 heures par client (de 2-3h à 15 min)", explanation: "L'onboarding automatisé fait passer le temps d'onboarding de 2-3 heures à 15 minutes par client. Sur 10 clients par an, cela représente plus de 20 heures productives récupérées." },
    ],
  },
  {
    order: 4,
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien peut rapporter une micro-formation à 197€ avec 10 ventes par mois ?", options: JSON.stringify(["197€/mois", "970€/mois", "1970€/mois", "5000€/mois"]), correctAnswer: "1970€/mois", explanation: "Une micro-formation à 197€ avec 10 ventes par mois (très atteignable avec 500+ abonnés LinkedIn actifs) génère 1970€/mois de revenus passifs. Avec 30 ventes/mois, cela monte à 5910€/mois." },
    ],
  },
  {
    order: 5,
...
Objectif financier global M1+M2+M3 :
  ...
  → Ambitieux : 15000€ de CA cumulé`,
    ...
    quiz: [
      ...
      { type: "true_false", question: "On est 95% plus susceptible d'atteindre un objectif si on a des check-ins réguliers avec un partenaire d'accountability.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "Les études montrent qu'on est 65% plus susceptible d'atteindre un objectif si on le partage avec quelqu'un, et 95% plus susceptible si on a des check-ins réguliers avec cette personne." },
      { type: "mcq", question: "Quel KPI permet de mesurer l'efficacité de tes propositions commerciales ?", options: JSON.stringify(["Nombre de messages de prospection envoyés", "Nombre de posts LinkedIn publiés", "Taux de conversion proposition → client (cible 20-30%)", "Nombre de formations suivies"]), correctAnswer: "Taux de conversion proposition → client (cible 20-30%)", explanation: "Le taux de conversion proposition → client mesure le pourcentage de propositions envoyées qui se transforment en contrats signés. L'objectif cible est de 20 à 30%." },
    ],
  },
];
