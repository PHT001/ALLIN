...
export const MODULE_3_LESSONS = [
  // ─── LEÇON 1 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quel combo d'outils est recommandé pour 80% des projets clients d'une agence IA ?", options: JSON.stringify(["Bolt + Lovable", "ChatGPT + WordPress", "v0.dev + Claude", "Cursor + Gemini"]), correctAnswer: "v0.dev + Claude", explanation: "Le combo v0.dev + Claude est recommandé pour 80% des projets clients : Claude pour structurer le contenu et la stratégie, v0 pour générer le design et le code React/Tailwind." },
    ],
  },
...
Make it look like a $10,000 agency website.` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Pourquoi préparer le contenu avec Claude AVANT d'utiliser v0 ?", options: JSON.stringify(["Parce que v0 ne peut pas générer de texte", "Pour économiser des crédits v0", "Pour avoir un contenu ciblé et pertinent avant de le mettre en forme visuellement", "Parce que v0 ne fonctionne qu'en anglais"]), correctAnswer: "Pour avoir un contenu ciblé et pertinent avant de le mettre en forme visuellement", explanation: "v0 est excellent pour le design, mais le contenu générique donne des résultats génériques. En préparant le vrai contenu avec Claude d'abord, le site final est immédiatement pertinent pour le client." },
    ],
  },
...
if (compteur > 5) {
  console.log("Tu as cliqué plus de 5 fois !");
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quelle est la bonne stratégie quand tu ne comprends pas un bout de code généré par l'IA ?", options: JSON.stringify(["Supprimer le code et recommencer", "Passer des heures à chercher sur Google", "Coller le code dans Claude et lui demander d'expliquer", "Ignorer le code et espérer que ça marche"]), correctAnswer: "Coller le code dans Claude et lui demander d'expliquer", explanation: "La règle d'or : si tu ne comprends pas un bout de code, colle-le dans Claude et demande-lui d'expliquer. Tu apprendras 10x plus vite qu'avec n'importe quel cours." },
    ],
  },
...
Exemple de données mock inclus pour tester.` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Où place-t-on les composants réutilisables (Navbar, Footer, Button) dans un projet Next.js ?", options: JSON.stringify(["Dans le dossier app/", "Dans le dossier components/", "Dans le dossier public/", "Dans le dossier pages/"]), correctAnswer: "Dans le dossier components/", explanation: "Les composants réutilisables se placent dans le dossier components/ à la racine du projet (ex: components/Navbar.tsx, components/Footer.tsx). Le dossier app/ est réservé aux pages et au routing." },
    ],
  },
...
# ✓ Ton code est maintenant sur GitHub !` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien de commandes Git sont nécessaires pour 95% des situations ?", options: JSON.stringify(["2 commandes", "4 commandes (status, add, commit, push)", "8 commandes", "12 commandes"]), correctAnswer: "4 commandes (status, add, commit, push)", explanation: "Git status (voir l'état), git add . (ajouter les fichiers), git commit -m 'message' (sauvegarder) et git push (envoyer) couvrent 95% des besoins quotidiens." },
    ],
  },
...
[Ton nom]` },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quel taux horaire minimum est considéré acceptable pour un freelance tech en France ?", options: JSON.stringify(["25€/h", "50€/h", "100€/h", "500€/h"]), correctAnswer: "100€/h", explanation: "100€/h (600€ pour 6h) est le minimum acceptable pour un freelance tech en France. 200€/h est justifiable si tu te positionnes comme consultant IA spécialisé. Ce qui compte : la valeur créée pour le client." },
    ],
  },
];
