...
export const MODULE_2_LESSONS = [
  // ─── LEÇON 1 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien de tokens de contexte Claude Pro peut-il gérer ?", options: JSON.stringify(["10 000 tokens", "50 000 tokens", "200 000 tokens", "1 000 000 tokens"]), correctAnswer: "200 000 tokens", explanation: "Claude Pro peut travailler avec 200 000 tokens de contexte, soit environ 150 000 mots. Cela permet de travailler sur des projets entiers sans perdre le fil." },
    ],
  },
  ...
  // ─── LEÇON 2 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien de frameworks de prompting avancé sont enseignés dans cette leçon ?", options: JSON.stringify(["3 frameworks", "5 frameworks", "7 frameworks", "10 frameworks"]), correctAnswer: "7 frameworks", explanation: "Les 7 frameworks sont : RCTF avancé, Chain of Thought, Few-Shot, Role-Play, Contraintes créatives, Itération dirigée et Meta-prompting." },
    ],
  },
  ...
  // ─── LEÇON 3 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Dans le template de landing page, quel est le principe clé pour rédiger chaque section ?", options: JSON.stringify(["Parler de son entreprise et ses valeurs", "Chaque section doit répondre à 'qu'est-ce que j'y gagne ?' du point de vue du client", "Utiliser un maximum de jargon technique", "Mettre le plus d'informations possible par section"]), correctAnswer: "Chaque section doit répondre à 'qu'est-ce que j'y gagne ?' du point de vue du client", explanation: "La contrainte clé du template landing page est que chaque section doit répondre à la question 'qu'est-ce que j'y gagne ?' vue du client. Tout est centré sur le client, jamais sur 'nous' ou 'notre entreprise'." },
    ],
  },
  ...
  // ─── LEÇON 4 ───
  {
    ...
    quiz: [
      ...
      { type: "true_false", question: "Le code généré par l'IA est toujours parfait du premier coup et ne nécessite jamais d'itération.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Le code généré par l'IA n'est pas parfait du premier coup. L'objectif est de comprendre la structure, puis d'itérer : génération → test → debug → version fonctionnelle." },
      { type: "mcq", question: "Quel type de prompt permet de créer un prototype rapide à montrer à un client ?", options: JSON.stringify(["Un prompt de refactoring", "Un prompt de prototype en HTML/CSS/JS vanilla qui s'ouvre directement dans le navigateur", "Un prompt de debug", "Un prompt de test unitaire"]), correctAnswer: "Un prompt de prototype en HTML/CSS/JS vanilla qui s'ouvre directement dans le navigateur", explanation: "Pour impressionner un client rapidement, on utilise un prompt de prototype en HTML/CSS/JS vanilla — pas de framework, le fichier s'ouvre directement dans un navigateur. Idéal pour un calculateur ROI ou une démo." },
    ],
  },
  ...
  // ─── LEÇON 5 ───
  {
    ...
    quiz: [
      ...
      { type: "mcq", question: "Quel est le format recommandé pour un prompt template réutilisable ?", options: JSON.stringify(["Un paragraphe continu sans structure", "Une structure RCTF avec des [VARIABLES] entre crochets pour ce qui change", "Juste le résultat attendu sans instruction", "Un simple mot-clé comme raccourci"]), correctAnswer: "Une structure RCTF avec des [VARIABLES] entre crochets pour ce qui change", explanation: "Un prompt réutilisable doit avoir une structure RCTF avec des variables clairement identifiées entre crochets [VARIABLE] pour tout ce qui change d'un usage à l'autre." },
    ],
  },
];
